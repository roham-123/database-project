...
// Use the global $conn variable from utilities.php
global $conn;
...
if ($result->num_rows === 0) {
    ...
    echo "<form method='post' action='place_bid.php'>
            <div class='form-group'>
                ...
                <input type='number' class='form-control' id='bid_amount' name='bid_amount' step='0.01' min='" . ($auction['StartPrice'] + 1) . "' required>
            </div>
